 ...
 * {@link AdminMapFragment.IAdminMapInteractionListener} interface
...
public class AdminMapFragment extends Fragment {
    ...
    private IAdminMapInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof IAdminMapInteractionListener) {
            mListener = (IAdminMapInteractionListener) context;
        } else {
     ...
     */
    public interface IAdminMapInteractionListener {
